# -*- coding: utf-8 -*-
"""
opms_theme.py - Theme + helper DUNG CHUNG cho cac app test OPMS.
====================================================================
Tach rieng he mau / font / nut bam de ca opms_test_app (Slave Board) va
ch348_test_app (Console CH348) dung chung 1 nguon -> dong bo, de phat trien.

Phong cach: Industrial / Engineering Software (Flat) - tham khao Keysight
BenchVue, STM32CubeProgrammer, Siemens TIA. Khong gradient / do bong / animation.

Dung:  from opms_theme import *
"""
...
# Map ten cu (tuong thich code hien co)
HDR_ACC  = HDR_BG
BLUE_ACC = HDR_BG      # tieu de card
GREY_TX  = SEC_TX
ON_BG    = PRIMARY
ON_HOV   = PRIMARY_HOV
OFF_BG   = SEC_BG
...
# Terminal (console)
TERM_BG = "#1F2933"
TERM_FG = "#D8E2EA"   # text / INFO
TERM_TX = "#FFFFFF"   # echo lenh
...
def flat_btn(parent, text, bg, hover, fg="white", relief="raised", bd=2,
             font=None, **kw):
    """Nut noi khoi (raised) - cam giac ky thuat (Smart PDU style).
    Truyen relief='flat', bd=0 neu muon nut phang; font=... de doi co chu."""
